        ...
        return (
            <React.Fragment>
                <Helmet>
                    ...
                    {_.get(this.props, 'pageContext.frontmatter.seo.canonical_url', null) ? (
                    <link rel="canonical" href={_.get(this.props, 'pageContext.frontmatter.seo.canonical_url', null)} />
                        ...
                        return (
                          <link rel="canonical" href={domain + page_rel_url} />
                        );
                    })()))}
                    {_.map(_.get(this.props, 'pageContext.frontmatter.seo.extra', null), (meta, meta_idx) => (
                      ((_.get(meta, 'name', null) === 'og:image') || (_.get(meta, 'name', null) === 'twitter:image')) ? (
                        _.get(meta, 'value', null).startsWith('http') ? (
                        <meta key={meta_idx} {...(_.get(meta, 'name', null).startsWith('og:') ? ({property: _.get(meta, 'name', null)}) : {name: _.get(meta, 'name', null)})} content={_.get(meta, 'value', null)}/>
                        ) : (_.get(this.props, 'pageContext.site.siteMetadata.domain', null) && ((() => {
                            let domain = _.trim(_.get(this.props, 'pageContext.site.siteMetadata.domain', null), '/');
                            let image_rel_url = withPrefix(_.get(meta, 'value', null));
                            return (
                              <meta key={meta_idx + '.1'} {...(_.get(meta, 'name', null).startsWith('og:') ? ({property: _.get(meta, 'name', null)}) : {name: _.get(meta, 'name', null)})} content={domain + image_rel_url}/>
                            );
                        })()))
                      ) : 
                        <meta key={meta_idx + '.2'} {...(_.get(meta, 'name', null).startsWith('og:') ? ({property: _.get(meta, 'name', null)}) : {name: _.get(meta, 'name', null)})} content={_.get(meta, 'value', null)}/>
                    ))}
                    {(font !== 'system-sans') && (
