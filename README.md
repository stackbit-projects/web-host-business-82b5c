...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/60182b5cef4ba900150baf49
...
To start editing your site, you can use the Sanity interface at https://web-host-business-82b5c.sanity.studio/.
...
Generated at `2021-02-01T16:26:54.287Z` by Stackbit version `0.3.44`.